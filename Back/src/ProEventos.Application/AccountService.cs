...
namespace ProEventos.Application
{
    public class AccountService : IAccountService
    {
        ...
        public async Task<SignInResult> CheckUserPasswordAsync(UserUpdateDto userUpDto, string password)
        {
            try
            {
                var user = await _userManager.Users.SingleOrDefaultAsync(x => x.UserName == userUpDto.UserName.ToLower());
        ...
        public async Task<UserUpdateDto> GetUserByUsernameAsync(string username)
        {
            ...
            {
                throw new Exception($"Erro ao tentar buscar usuario por nome. Erro:{ex.Message}");
            }
        }
